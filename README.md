...
[![Downloads](https://img.shields.io/github/downloads/sheumais/logs/total?style=flat)](https://github.com/sheumais/logs/releases/latest/)

This application is designed to help you manage and process your Elder Scrolls Online Encounter log files.

### Comparison with ESO Logs Uploader

| Feature | ESO Log Tool | esologs.com |
| ------- | :----------: | :---------: |
| Upload to esologs.com | ✅ | ✅ |
| Live log to esologs.com | ✅ | ✅ |
...
Unhappy with the current features? Feel free to make an issue or pull request!
